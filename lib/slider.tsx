...
import { twJoin as cx } from "tailwind-merge";
    ...
    >
      ...
      <AriaSliderTrack className="relative h-6 w-full">
        {({
          ...
          return (
            <>
              <span className="absolute top-1/2 h-2 w-full -translate-y-1/2 rounded-full bg-white/8" />
              <span
                ...
                return (
                  <AriaSliderThumb
                    ...
                    className={({ isFocusVisible, isDragging }) =>
                      cx(
                        "top-1/2 box-border size-6 cursor-grab rounded-full bg-neutral-800 shadow-md ring-3 ring-white/20 ring-inset",
                        isFocusVisible &&
